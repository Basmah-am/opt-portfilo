...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
      //old un-optomize code
//         for (var i = 0; i < document.querySelectorAll(".randomPizzaContainer").length; i++) {
//      var dx = determineDx(document.querySelectorAll(".randomPizzaContainer")[i], size);
//      var newwidth = (document.querySelectorAll(".randomPizzaContainer")[i].offsetWidth + dx) + 'px';
//      document.querySelectorAll(".randomPizzaContainer")[i].style.width = newwidth;

     //get all the Containers by class name
     var ContainersList = document.getElementsByClassName("randomPizzaContainer");
      // set the value of dx and newwidth of first element outside the loop 
      var dx = determineDx(ContainersList['0'], size);
      var newwidth = (ContainersList['0'].offsetWidth + dx) + 'px';

   for (var i = 0; i < ContainersList.length; i++) {
     ContainersList[i].style.width = newwidth;
   }
  }
...
// change ----> call updatePositions function with requestAnimationFrame method
